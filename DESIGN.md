...
| NeoForge | **21.1.200** (최신 안정) | 모드 서버 로더 |
...
| 체육관 | 타입 | 관장 레벨 기준 | 비고 |
|--------|------|--------------|------|
| 체육관 1 | 불꽃 | 플레이어 최고 레벨 | 입문용 |
| 체육관 2 | 물 | 플레이어 최고 레벨 | 중급 |
| 체육관 3 | 전기 | 플레이어 최고 레벨+5 | 상급 |
| (선택) 체육관 4 | 드래곤 | 플레이어 최고 레벨+10 | 고난이도 |

> 체육관 타입/수는 Phase 3에서 확정. 위는 설계 예시.
